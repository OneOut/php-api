...
class Common {
	...
	public function check(){
		...
		$this->params['version_id'] = $appId = isset($_POST['version_id']) ? $_POST['version_id'] : '';
		$this->params['version_mini'] = $appId = isset($_POST['version_mini']) ? $_POST['version_mini'] : '';
		$this->params['did'] = $appId = isset($_POST['did']) ? $_POST['did'] : '';
		$this->params['encrypt_did'] = $appId = isset($_POST['encrypt_did']) ? $_POST['encrypt_did'] : '';
